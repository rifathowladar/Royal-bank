...
import { LayoutDashboard, Store, ArrowRightLeft, Landmark } from 'lucide-react';

export const AdminQrNav: React.FC = () => {
  const tabs = [
    { label: 'QR Command Center', path: '/admin/qr', icon: LayoutDashboard, end: true },
    { label: 'Merchant Directory', path: '/admin/qr/merchants', icon: Store },
    { label: 'QR Transactions', path: '/admin/qr/transactions', icon: ArrowRightLeft },
    { label: 'Settlement Escrow', path: '/admin/qr/settlements', icon: Landmark },
  ];
