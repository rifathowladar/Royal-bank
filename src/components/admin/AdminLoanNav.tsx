...
import { Banknote, FileCheck, Layers } from 'lucide-react';

export const AdminLoanNav: React.FC = () => {
  const tabs = [
    { label: 'Active Credit Facilities', path: '/admin/loans', icon: Banknote, end: true },
    { label: 'Underwriting Applications Queue', path: '/admin/loans/applications', icon: FileCheck },
  ];
